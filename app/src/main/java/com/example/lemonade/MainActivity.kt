...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        music = MediaPlayer.create(this, R.raw.relax)
...
//        timer = DessertTimer(lifecycle)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt(MUSIC, music.currentPosition)
    ...
    private fun clickLemonImage() {
        ...
        if (lemonadeState == SELECT) {
            ...
            val fragment = supportFragmentManager.findFragmentById(R.id.score_fragment_container) as ScoreFragment
            fragment.updateTotalScore(lemonSize.toString())
        }
